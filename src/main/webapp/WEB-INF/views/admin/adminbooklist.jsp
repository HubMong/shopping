...
<body>
  ...
  <div class="menu-container">
    <div class="menu-box"><a href="<c:url value='/admin/books'/>">📚 책 리스트</a></div>
    <div class="menu-box"><a href="<c:url value='/admin/adminmemberlist'/>">👥 회원 리스트</a></div>
    <div class="menu-box"><a href="<c:url value='/admin/adminorderlist'/>">🧾 주문 리스트</a></div>
  </div>
