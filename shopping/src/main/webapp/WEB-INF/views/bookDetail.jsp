...
<body>
  ...
  <div class="book-container">
    <div class="cover">
      <img src="${pageContext.request.contextPath}${book.imagePath}" alt="${book.title}" onerror="this.src='${pageContext.request.contextPath}/resources/images/default_cover.jpg'; this.onerror=null;"/>
    </div>
    <div class="info">
      <h1>${book.title}</h1>
      ...
      <div class="buttons">
        ...
        <form action="${pageContext.request.contextPath}/order/buyNow" method="post">
            <input type="hidden" name="bookId" value="${book.id}">
