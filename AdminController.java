...
public class AdminController {
	...
	public ModelAndView adminMainlist(@RequestParam(value = "keyword", required = false) String keyword, ModelAndView mv) {
	    if (keyword != null && !keyword.trim().isEmpty()) {
	        mv.addObject("books", adminservice.searchBooks(keyword.trim()));
	    } else {
	        mv.addObject("books", adminservice.getBookList());
	    }
	    mv.addObject("searchKeyword", keyword); // 검색어 유지
